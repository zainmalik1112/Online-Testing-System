...
class ExamQuestions extends StatefulWidget {
  ...
  final testID;
  ExamQuestions({this.testID});

  @override
  _ExamQuestionsState createState() => _ExamQuestionsState(testID: this.testID);
}

class _ExamQuestionsState extends State<ExamQuestions> {

  final testID;
  _ExamQuestionsState({this.testID});
  ...
  buildBody()
  {
    return ListView(
      children: <Widget>[
        StreamBuilder(
          stream: Firestore.instance.collection('FullTestCollection')
